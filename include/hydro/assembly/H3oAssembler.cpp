...
VM_Type *H3oAssembler::parseTypeSpec()
{
	validate(":");
	...
	else if (match(".construct"))
	{
		...
		if (owner)
		{
            ...
            else
            {
                ...
                construct->returnType = new VM_NilType{};
...
void H3oAssembler::onParseInit()
{
	...
	_mainFunc->returnType = new VM_NilType{};
