...
#ifndef __h3o_engine_EngineLexer__
#define __h3o_engine_EngineLexer__
...
{
/**
 * The engine_lexer_state is required to alter how the lexer creates tokens for given situations.
 */
enum engine_lexer_state
{
    engine_parse_entity,
 ...
 *
 */
class PerformanceLexer : public compiler::Lexer
{
public:
    /**
     *
     ...
     *
     */
    PerformanceLexer(compiler::ErrorReporter *errorReporter);

    /**
     *
     */
    virtual ~PerformanceLexer();

    engine_lexer_state getState() const { return mState; }

    void setState(engine_lexer_state state) { mState = state; }
...
#endif /* __h3o_engine_EngineLexer__ */
