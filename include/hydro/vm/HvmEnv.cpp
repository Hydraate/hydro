...
void HvmEnv::setup(HvmInitOptions *options)
{
     ...
     * Geometry
     */
    _nativeService->type("system/geometry/Rectangle", &HRectangle::construct)
        ->property("x", &HRectangle::h3o_get_x, &HRectangle::h3o_set_x)
        ->property("y", &HRectangle::h3o_get_y, &HRectangle::h3o_set_y)
        ->property("width", &HRectangle::h3o_get_width, &HRectangle::h3o_set_width)
        ->property("height", &HRectangle::h3o_get_height, &HRectangle::h3o_set_height)
    ;
    
    /**
     * Drip
     */
    _nativeService->type("system/drip/Element", &HElement::construct);
